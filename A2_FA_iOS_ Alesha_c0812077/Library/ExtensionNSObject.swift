...
extension NSObject
{
    ...
    func getObject(forKey key:UnsafeRawPointer) -> AnyObject?
    {
    ...
    {
        return self.getObject(forKey: key)!.intValue
    }
    ...
    {
        return self.getObject(forKey: key)!.floatValue
    }
    ...
    {
        return self.getObject(forKey: key)!.doubleValue
    }
    ...
    {
        return self.getObject(forKey: key)!.boolValue
    }
